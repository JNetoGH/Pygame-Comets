...
class InspectorDebuggingCanvas:
    ...
    @staticmethod
    def _render_rect_of_rect_based_component(component: Union[ColliderComponent, RectTriggerComponent], color, font, font_size):
        ...
        representative_rect = component.collider_rect.copy()
