from engine_JNeto_Productions.components.animation.animation_clip import AnimationClip
from engine_JNeto_Productions.components.animation.animation_controller_component import AnimationControllerComponent
...
class MapLimits(GameObject):
    def __init__(self, scene):
        ...
        self.single_sprite = SingleSpriteComponent("game_res/limits.png", self)
