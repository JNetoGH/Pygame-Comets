import pygame
from JNeto_Productions_Engine.components.component_base_class.component_base_class import Component
...
class TriggerComponent(Component):
    def __init__(self, offset_from_game_object_x, offset_from_game_object_y, width, height, game_object_owner):
        ...
        self._trigger_inner_rect: pygame.Rect = pygame.Rect(0, 0, 0, 0)
        ...
        self._trigger_inner_rect.width = self.width
        self._trigger_inner_rect.height = self.height
    ...
    def realign_with_game_object_owner(self):
        ...
        self._trigger_inner_rect.centerx = round(self.game_object_owner.transform.world_position_read_only.x + self.offset_from_game_object_x)
        self._trigger_inner_rect.centery = round(self.game_object_owner.transform.world_position_read_only.y + self.offset_from_game_object_y)
